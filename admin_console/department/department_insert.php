...
// if everything is ok, try to upload file
...
else
 {
  ...
  {
    $sql="insert into departments(name,definition,image) values('$new_name','$new_definition','$target_file')";
...
if(isset($_POST['delete'])) {
  $id=$_POST['id1'];
  $sql="delete from departments where sno=$id";
...
echo "<script>window.location.href = '../home/department_home.php';</script>";
?>