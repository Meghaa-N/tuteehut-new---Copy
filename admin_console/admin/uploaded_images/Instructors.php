...
-->
<section style="background-color: #010217; height: 55vh; width: auto; padding-top: 40vh">
...
<!--<img src="admin/uploaded_images/<?php echo $detail['image'];?>" alt="Image" onerror="this.onerror = null; this.src='admin/uploaded_images/tree-736885_1280.jpg'" class = "img-fluid">--><!--<img src="admin/uploaded_images/<?php echo detail['image']; ?>" alt="admin/uploaded_images/tree-736885_1280.jpg"> --></div>
</div>
<div class="text pt-3">
<h3><a href="https://preview.colorlib.com/theme/studylab/instructor-details.html"><?php echo htmlspecialchars($detail['name']); ?></a></h3>
...
<div class="col-md pt-5">
<div class="ftco-footer-widget pt-md-5 mb-4">
<h2 class="ftco-heading-2" style="color: #edf0f5;">Have a Question?</h2>
